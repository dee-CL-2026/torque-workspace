...
| ID | Task | Project | Assigned | Status | Added | Notes |
|----|------|------|--------|--------|-------|
| T001 | Send 2024-2025 financial data to Anders | candid | Dee | pending | 2026-02-06 | From Anders call |
| T002 | Ask Ryan for pitch deck + 3 marketing scenarios | general | Dee | pending | 2026-02-06 | From Anders call |
| T003 | Follow up: Teddy (KKS) | general | Dee | pending | 2026-02-06 |  |
| T004 | Follow up: PKF (Cheryl) | general | Dee | pending | 2026-02-06 |  |
| T005 | Follow up: Jules (zero cap accounts) | general | Dee | pending | 2026-02-06 |  |
| T006 | Push SKD for sales data + road show data | candid | Dee | pending | 2026-02-06 |  |
| T007 | Get Ferry involved in all groups | candid | Dee | pending | 2026-02-06 |  |
| T008 | Get Finns co-branding contract | candid | Dee | pending | 2026-02-06 | For budget data |
| T009 | Share historical data from SKD | candid | Dee | pending | 2026-02-05 | For Modern Trade assessment |
| T010 | Get second SIM for WhatsApp bot | torque | Dee | pending | 2026-02-02 | Dedicated bot number |
| T011 | Set up Obsidian mobile + Git sync | general | Dee | pending | 2026-02-07 | [desk] Deprioritised — using GitHub web + VS Code |
| T012 | Install OpenClaw Browser Relay extension | torque | Dee | pending | 2026-02-08 | [desk] Chrome Web Store |
| T013 | Introduce Torque in Pizza Pasta Prosecco group | general | Dee | pending | 2026-02-08 | Mention @Torque to intro |
| T014 | Get Anthropic pay-per-use API key | general | Dee | pending | 2026-02-07 | console.anthropic.com, unlocks Sonnet/Haiku |
